package net.milkbowl.modules.permission.plugins;

import net.milkbowl.modules.permission.Permission;
...
public class Permission_None implements Permission {
    ...
    /*
     * @see
     * com.milkbukkit.localshops.modules.permission.Permission#inGroup(java.
     * lang.String, java.lang.String, java.lang.String) Users can never be in
     * groups without a permissions plugin - always resolves false if checked.
     */
    @Override
